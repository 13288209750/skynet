...
import com.hdg.util.serializable.impl.SerializableByStream;
 ...
 */
public class SerializableByStreamTest extends BaseTest{
    ...
    @Before
    public void before(){
        ISerializableUtil iSerializableUtil=new SerializableByStream();
        User user=new User();
